...
//    public final static String FILE_UPLOAD_DIC = "/Users/picopicopico/Programmer/Project/Java_Project/newbee-mall-api/src/main/resources/upload/";//上传文件的默认url前缀，根据部署设置自行修改
